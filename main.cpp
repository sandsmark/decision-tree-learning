/*
 * Decision tree learning implementation in C++
 * Copyright 2010 Martin T. Sandsmark <martin.sandsmark@kde.org>
 *
 * This is part of a solution to exercise 4 in the course
